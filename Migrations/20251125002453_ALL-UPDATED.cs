    ...
    public partial class ALLUPDATED : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskAssignments_UserTasks_TaskId",
                        column: x => x.TaskId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserXpHistoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserXpHistories", x => x.UserXpHistoryId);
                    table.ForeignKey(
                        name: "FK_UserXpHistories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CompletionFeedbacks",
                columns: table => new
                {
                    CompletionFeedbackId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaskAssignmentId = table.Column<int>(type: "int", nullable: false),
                    PerceivedOutcome = table.Column<byte>(type: "tinyint", nullable: false),
                    XpBase = table.Column<int>(type: "int", nullable: false),
                    DifficultyAverage = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    FeedbackFactor = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    XpFinal = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletionFeedbacks", x => x.CompletionFeedbackId);
                    table.ForeignKey(
                        name: "FK_CompletionFeedbacks_TaskAssignments_TaskAssignmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DifficultyVoteId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TaskAssignmentId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DifficultyVotes", x => x.DifficultyVoteId);
                    table.ForeignKey(
                        name: "FK_DifficultyVotes_TaskAssignments_TaskAssignmentId",
                        column: x => x.TaskAssignmentId,
                        principalTable: "TaskAssignments",
                        principalColumn: "TaskAssignmentId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompletionFeedbacks_TaskAssignmentId",
                table: "CompletionFeedbacks",
                column: "TaskAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_DifficultyVotes_TaskAssignmentId",
